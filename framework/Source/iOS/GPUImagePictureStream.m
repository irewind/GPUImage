#import "GPUImagePictureStream.h"

@implementation GPUImagePictureStream
...
- (id)initWithCGImage:(CGImageRef)newImageSource smoothlyScaleOutput:(BOOL)smoothlyScaleOutput;
{
    ...
    [self setImage:newImageSource smoothlyScaleOutput:smoothlyScaleOutput];
...
- (void)processImage;
{
    [self processImageWithTime:kCMTimeIndefinite];
}
